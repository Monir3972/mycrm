                            ...
                            <div class="tab-content text-muted mt-3 mt-lg-0">
                                <div class="tab-pane fade active show row">
                                    <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        @if(!empty($rightMedia))
                                                        <div class="row">
                                                            <img class="col-4 img-fluid" alt="{{ $rightHeading }}" src="{{ asset('/') }}public/assets/images/section/{{ $rightMedia }}">
                                                        </div>
                                                        @endif
                                        ...
                                        <!-- section eight will end here -->
                                        <form class="form my-4" method="POST" action="{{ route('saveHomeSection10') }}" enctype="multipart/form-data">
