            ...
            <div class="container">
                <ul class="st-nav-menu nav navbar-nav">
                    ...
                    <li class="st-nav-section st-nav-primary nav-item">
                        ...
                        <a href="integration.html" class="st-root-link nav-link">
                            Feature
                        </a>
                    ...
                    <li class="st-nav-section st-nav-secondary nav-item">
                        <a href="{{route('login')}}" class="btn btn-outline rounded-pill me-3 px-3" target="_blank">
                            <i class="fas fa-sign-in-alt d-none d-md-inline me-md-0 me-lg-2"></i>
                            <span class="d-md-none d-lg-inline">Login</span>
                        </a>

                        <a href="{{ route('register')}}" class="btn btn-solid rounded-pill px-3" target="_blank">
                ...
                <div class="container">
                    <div class="row gap-y text-center text-md-start">
                        <div class="col-md-4 me-auto">
                            <img src="{{ asset('/') }}assets/img/logo-footer.png" alt="" class="logo" />
